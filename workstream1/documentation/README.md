...
The proposed tool must facilitate the checks for several eligibility conditions
for CMF financing. 
...
The data must be collected for each project
to evaluate the grant applications along the above eligibility criteria
and in terms of their merit for addressing the affordable housing problem. 
The current procedure is described next before the 
proposed procdures using an automated procedure. 
...
Regardless of the method of data entry, 
a defined set of information must be collected
and organized to process the grant applications for eligibility
and their merit for addressing the affordable housing problem. 
